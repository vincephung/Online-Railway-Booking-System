                        ...
                        <form class="form-signin" action="handleRegister.jsp" method="POST">
                           ...
                           <div class="form-label-group">
                              <div class="form-check">
                                 <input class="form-check-input" id="disabledCheck" type="checkbox" value="true" name="disabled">									  
                           ...
                           <div class="form-label-group rep-ssn">
                              <input type="text" class="form-control" placeholder="Enter SSN if you are a customer representative" maxlength="9" name="ssn">
                           </div>
